...
static NSString * const ktest2Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_test2Injection
{
	...
	[html appendString:ktest2Javascript];
...
{
	// attempt to make well-formed HTML and inject in our test2 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _test2Injection]];

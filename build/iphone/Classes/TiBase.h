...
// in simulator we redefine to format for test2 Developer console
...
{\
	NSString * exceptionName = [@"org.test2." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.test2";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItest2NativeItemNone = -1, 
	UItest2NativeItemSpinner = -2,
	UItest2NativeItemProgressBar = -3,
	
	UItest2NativeItemSlider = -4,
	UItest2NativeItemSwitch = -5,
	UItest2NativeItemMultiButton = -6,
	UItest2NativeItemSegmented = -7,
	
	UItest2NativeItemTextView = -8,
	UItest2NativeItemTextField = -9,
	UItest2NativeItemSearchBar = -10,
	
	UItest2NativeItemPicker = -11,
	UItest2NativeItemDatePicker = -12,
	
	UItest2NativeItemInfoLight = -13,
	UItest2NativeItemInfoDark = -14,
	
	UItest2NativeItemDisclosure = -15,
	
	UItest2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all test2 instances of

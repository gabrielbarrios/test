...
/**
 The base class for all test2 modules
 */
...
/**
 test2 Platform calls this method on startup.
 */
-(void)startup;

/**
 test2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 test2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 test2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 test2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
